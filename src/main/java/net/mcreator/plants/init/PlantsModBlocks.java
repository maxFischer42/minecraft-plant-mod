...
import net.mcreator.plants.block.SpottedBegoniaPotBlock;
...
public class PlantsModBlocks {
	...
	public static final RegistryObject<Block> SPOTTED_BEGONIA_POT = REGISTRY.register("spotted_begonia_pot", () -> new SpottedBegoniaPotBlock());
}
